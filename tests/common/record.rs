...
// use std::ops::Deref;
// use jammdb::{Bucket, Error, File, OpenOption, OpenOptions, PathLike, ToBytes, Tx};
...
// =
// impl Bytes {
//     pub fn from_static(bytes: &[u8]) -> Bytes {
//         Bytes {
//             bytes: bytes.to_vec(),
//         }
//     }
//     pub fn from(bytes: &[u8]) -> Bytes {
//         Bytes {
//             bytes: bytes.to_vec(),
//         }
//     }
...
//             }
//             self.pos = i + 1;
//             line.push_str(std::str::from_utf8(&self.buf[self.pos..i]).unwrap());
//         }
//         lines
//     }
//
...
//     let mut log = BufReader::new(File::open(name)?);
